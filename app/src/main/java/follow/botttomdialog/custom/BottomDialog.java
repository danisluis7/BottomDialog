...
import follow.botttomdialog.R;
import follow.botttomdialog.bean.Item;
import follow.botttomdialog.utils.Utils;
...
public class BottomDialog {
    ...
    private class CustomDialog extends Dialog implements View.OnClickListener {
        ...
        /**
         * If you use version <= 26 => We will get error from Bitmap bitmap = ((BitmapDrawable) drawable).getBitmap();
